...
export const candidates: Candidate[] = [
  ...
  cand({
    ...
    residence: { country: "日本", city: "コロンボ" },
    jlpt: "N3",
  ...
  cand({
    ...
    residence: { country: "日本", city: "マータラ" },
    jlpt: "N4",
    backgroundSummary: "元警察官。責任感と指導力。",
    educationWorkHistory: "日本警察3年。その後警備会社。",
  ...
  cand({
    ...
    residence: { country: "日本", city: "ネゴンボ" },
    jlpt: "N4",
    backgroundSummary: "日本国内の食品工場経験あり。",
  ...
  cand({
    ...
    residence: { country: "日本", city: "アヌラーダプラ" },
    jlpt: "N3",
  ...
  cand({
    ...
    residence: { country: "日本", city: "クルネーガラ" },
    jlpt: "N4",
